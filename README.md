...
## Быстрый старт
1. `make setup` — устанавливает системные утилиты (shellcheck, go и т.п.), разворачивает `.venv` и ставит Python/Go-зависимости (pytest, diff-cover, detect-secrets, reviewdog) с контролируемой версией pip.
